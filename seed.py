...
def seed_data():
    with app.app_context():
        if not User.query.first():
            users = [
                User(username='student1', password='password1', role='student', name='John', surname='Doe'),
                User(username='tutor1', password='password1', role='tutor', name='Jane', surname='Smith'),
                User(username='tutor2', password='password2', role='tutor', name='Emily', surname='Jones'),
                User(username='admin', password='admin', role='admin', name='Admin', surname='User'),
            ]
